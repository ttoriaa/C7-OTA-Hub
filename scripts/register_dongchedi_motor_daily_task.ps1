param(
    [string]$TaskName = "DongchediDailyMotorBenchmark",
    [string]$Time = "09:00",
...
$runnerScriptPath = Join-Path $WorkspacePath "scripts\run_dongchedi_motor_task_runner.ps1"
...
Write-Host "Pipeline: generate motor daily artifacts, then publish to Confluence"
